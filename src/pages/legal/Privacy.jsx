    ...
    >
      ...
      <Table
        ...
        rows={[
          [
            'Email address',
            'Identifies your account and your purchase; used to send sign-in links and receipts.',
          ...
          [
            'Purchase record',
            'Amount, currency, status, Stripe session and payment identifiers, and the date paid — proof of what you bought.',
            'Contract, and legal obligation (tax and accounting records)',
          ],
          [
            'Account tier and attempt count',
            'Decides whether you may sit another exam and whether results are shown to you.',
            'Performance of the contract',
          ],
          [
            'Technical logs',
      ...
      <H2 id="card-data">3. Card details</H2>
      <P>
        We never see them. Payment happens on Stripe's own hosted checkout page; your card number,
        expiry and CVC go straight to Stripe. What comes back to us is the outcome, the amount and an
        opaque identifier. We could not leak your card number if we tried.
      </P>

      <H2 id="storage">4. Cookies and browser storage</H2>
      <P>
      ...
      <H2 id="processors">5. Who else processes your data</H2>
      <P>
      ...
      <Table
        ...
        rows={[
          ...
          ['Stripe', 'Payment processing, fraud prevention and receipts.', 'USA / EU'],
      ...
      <UL>
        ...
        <LI>
          <strong>Purchase and payment records</strong> — retained for{' '}
          <Fill>7 years</Fill> after the transaction, because tax and accounting law requires it. This
          survives account deletion; it is the one thing we cannot erase on request.
        </LI>
        <LI>
