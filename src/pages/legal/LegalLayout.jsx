 ...
 *
 * Every legal document on the site is reachable from every other one — a
 * customer who lands on the refund policy from a Stripe receipt should not have
 * to hunt for the terms it refers to.
 */
...
export default function LegalLayout({ title, summary, children }) {
  // These pages are linked from receipts and from Stripe, so a visitor often
